...
class PatchWSIDataset(Dataset):
    ...
    def __init__(
        ...
        #     ToDo data should throw a meaningful exceptions if it's missing any fields:
        for key in ["image", "location", "label"]:
            for this in data:
                if key not in this.keys():
                    raise ValueError("Missing one of the mandatory fields for the data variable. It requires all"
                                     " of \"image\", \"label\", and \"location\" keys!")
